...
public abstract class StickerView extends FrameLayout{
    ...
    private void init(Context context){
        ...
        final LayoutParams this_params =
                new LayoutParams(
                        size,
                        size
                );
...
//                    myCanvas.removeView(StickerView.this);
    ...
    public void ShowImageTouch(){
        this.setOnTouchListener(mTouchListener);
        this.iv_scale.setOnTouchListener(mTouchListener);
        setControlItemsHidden(false);
    }
    public void ShowTextTouch(){
        this.setOnTouchListener(mTouchListener);
        this.iv_scale.setOnTouchListener(mTouchListener);
        setControlItemsHidden(false);
    }
    ...
    public abstract int setImageDrawable(int int_id_img);

    public abstract Object showTouchText(Object cpd_next);
    ...
    private static int convertDpToPixel(float dp, Context context){
        ...
        float px = dp * (metrics.densityDpi / 130f);
        return (int)px;
    }
